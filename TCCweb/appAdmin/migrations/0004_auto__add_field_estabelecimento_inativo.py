...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Estabelecimento.inativo'
        db.add_column(u'appAdmin_estabelecimento', 'inativo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Estabelecimento.inativo'
        db.delete_column(u'appAdmin_estabelecimento', 'inativo')
